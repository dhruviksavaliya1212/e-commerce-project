  ...
  return (
    <div className=" min-h-screen w-full pt-20 flex  justify-center">
      <div className=" w-[95%]">
        {getTotalCartAmount() ? (
          <div>
            <div className=" hidden sm:grid grid-cols-[1fr_2fr_1fr_0.5fr_1fr_1fr] item-center justify-center p-5 font-semibold border-b-2 border-b-zinc-800 bg-orange-500/50  shadow-md shadow-zinc-600">
              <p>Image</p>
              <p>Name</p>
              <p>Price</p>
              <p>Quentity</p>
                ...
                if (cartItem[item._id] > 0) {
                  return (
                    ...
                    >
                      ...
                      />
                      <h2 className=" font-semibold text-lg sm:text-md">
                        {item.name}
                      </h2>
                      <h3>
                      ...
                      <h2>
                        <span className=" sm:hidden mr-5">Quentity</span>
                        {cartItem[item._id]}
                      </h2>
                      <h2>
                      ...
                      <button
                        ...
                        className=" mb-3 sm:mb-0 w-[150px] sm:w-[130px] md:w-[140px] bg-red-600 px-5 py-2 shadow-md shadow-zinc-700 rounded-full font-semibold cursor-pointer"
                      >
                        Remove
                      </button>
                    </div>
